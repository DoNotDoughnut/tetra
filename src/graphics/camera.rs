...
impl Camera {
    ...
    pub fn with_window_size(ctx: &TetraContext) -> Camera {
    ...
    pub fn mouse_position(&self, ctx: &TetraContext) -> Vec2<f32> {
    ...
    /// As such, it does not take into account any other transformations
    /// being made to the view (e.g. screen scaling).
    pub fn mouse_x(&self, ctx: &TetraContext) -> f32 {
    ...
    /// As such, it does not take into account any other transformations
    /// being made to the view (e.g. screen scaling).
    pub fn mouse_y(&self, ctx: &TetraContext) -> f32 {
