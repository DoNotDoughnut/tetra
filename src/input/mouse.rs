...
pub fn is_mouse_button_down(ctx: &TetraContext, button: MouseButton) -> bool {
    ctx.input.mouse_buttons_down.contains(&button)
}

/// Returns true if the specified mouse button is currently up.
pub fn is_mouse_button_up(ctx: &TetraContext, button: MouseButton) -> bool {
    !ctx.input.mouse_buttons_down.contains(&button)
}

/// Returns true if the specified mouse button was pressed since the last update.
pub fn is_mouse_button_pressed(ctx: &TetraContext, button: MouseButton) -> bool {
...
/// down/left.
pub fn get_mouse_wheel_movement(ctx: &TetraContext) -> Vec2<i32> {
    ctx.input.mouse_wheel_movement
}

pub(crate) fn set_mouse_button_down(ctx: &mut TetraContext, btn: MouseButton) -> bool {
...
pub(crate) fn set_mouse_button_up(ctx: &mut TetraContext, btn: MouseButton) -> bool {
...
pub(crate) fn set_mouse_position(ctx: &mut TetraContext, position: Vec2<f32>) {
    ctx.input.mouse_position = position;
}

pub(crate) fn apply_mouse_wheel_movement(ctx: &mut TetraContext, wheel_movement: Vec2<i32>) {
