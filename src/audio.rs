...
impl Sound {
    ...
    pub fn play(&self, ctx: &TetraContext) -> Result<SoundInstance> {
        ctx.audio
    ...
    /// * [`TetraError::NoAudioDevice`] will be returned if no audio device is active.
    /// * [`TetraError::InvalidSound`] will be returned if the sound data could not be decoded.
    pub fn repeat(&self, ctx: &TetraContext) -> Result<SoundInstance> {
        ctx.audio
    ...
    /// * [`TetraError::NoAudioDevice`] will be returned if no audio device is active.
    /// * [`TetraError::InvalidSound`] will be returned if the sound data could not be decoded.
    pub fn spawn(&self, ctx: &TetraContext) -> Result<SoundInstance> {
        ctx.audio
    ...
    /// * [`TetraError::NoAudioDevice`] will be returned if no audio device is active.
    /// * [`TetraError::InvalidSound`] will be returned if the sound data could not be decoded.
    pub fn play_with(&self, ctx: &TetraContext, volume: f32, speed: f32) -> Result<SoundInstance> {
        ctx.audio
    ...
    /// * [`TetraError::NoAudioDevice`] will be returned if no audio device is active.
    /// * [`TetraError::InvalidSound`] will be returned if the sound data could not be decoded.
    pub fn repeat_with(&self, ctx: &TetraContext, volume: f32, speed: f32) -> Result<SoundInstance> {
        ctx.audio
    ...
    /// * [`TetraError::NoAudioDevice`] will be returned if no audio device is active.
    /// * [`TetraError::InvalidSound`] will be returned if the sound data could not be decoded.
    pub fn spawn_with(&self, ctx: &TetraContext, volume: f32, speed: f32) -> Result<SoundInstance> {
        ctx.audio
...
pub fn set_master_volume(ctx: &mut TetraContext, volume: f32) {
    ctx.audio.set_master_volume(volume);
}

/// Gets the master volume for the game.
pub fn get_master_volume(ctx: &mut TetraContext) -> f32 {
